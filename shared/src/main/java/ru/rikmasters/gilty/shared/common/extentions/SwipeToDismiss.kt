...
//import ru.rikmasters.gilty.shared.common.extentions.DismissDirection.EndToStart
//import ru.rikmasters.gilty.shared.common.extentions.DismissDirection.StartToEnd
//import ru.rikmasters.gilty.shared.common.extentions.DismissValue.Default
//import ru.rikmasters.gilty.shared.common.extentions.DismissValue.DismissedToEnd
//import ru.rikmasters.gilty.shared.common.extentions.DismissValue.DismissedToStart
...
//class DismissState(
//    initialValue: DismissValue, confirmStateChange: (DismissValue) -> Boolean = { true }
...
//        get() = if(offset.value == 0f) null
//        else if(offset.value > 0f) StartToEnd
//        else EndToStart
//
//    /**
...
//        return currentValue == if(direction == StartToEnd) DismissedToEnd
//        else DismissedToStart
//    }
//
//    /**
...
//        val targetValue = if(direction == StartToEnd) DismissedToEnd
//        else DismissedToStart; animateTo(targetValue)
//    }
//
//    companion object {
//
...
//        ) = Saver<DismissState, DismissValue>({ it.currentValue },
//            { DismissState(it, confirmStateChange) })
//    }
//}
//
///**
...
//    }
//
//    val minFactor = if(EndToStart in directions) StandardResistanceFactor
//    else StiffResistanceFactor
//
//    val maxFactor = if(StartToEnd in directions) StandardResistanceFactor
//    else StiffResistanceFactor
//
//    Box(
//        Modifier.swipeable(
...
//                width, minFactor, maxFactor
//            )
//        )
//    ) {
//        Row(Modifier.matchParentSize()) { background() }
//        Row(Modifier.offset {
//            IntOffset(
//                state.offset.value.roundToInt(), 0
//            )
//        }) { dismissContent() }
//    }
//}
...
//    return when { // settled at the default state
//        from == to && from == Default -> null // has been dismissed to the end
//        from == to && from == DismissedToEnd -> StartToEnd // has been dismissed to the start
//        from == to && from == DismissedToStart -> EndToStart // is currently being dismissed to the end
//        from == Default && to == DismissedToEnd -> StartToEnd // is currently being dismissed to the start
//        from == Default && to == DismissedToStart -> EndToStart // has been dismissed to the end but is now animated back to default
//        from == DismissedToEnd && to == Default -> StartToEnd // has been dismissed to the start but is now animated back to default
