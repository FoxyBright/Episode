...
import ru.rikmasters.gilty.presentation.ui.presentation.main.recommendation.TodayMeetingsListComposePreview
...
fun Navigation() {
    ...
    NavHost(navController, "test") {
        composable("test") { TodayMeetingsListComposePreview() }
